module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    ftpush: {
      stage: {
        ...
        src: 'public',
        dest: '/stage_aas/projects/news/strikeforce-report',
      ...
      prod: {
        ...
        src: 'public',
        dest: '/prod_aas/projects/news/strikeforce-report',
        exclusions: ['dist/tmp','Thumbs.db'],
        simple: true,
        useList: false
      }
  ...
  grunt.registerTask('default', ['jshint', 'archieml', 'clean', 'copy', 'less', 'requirejs']);
